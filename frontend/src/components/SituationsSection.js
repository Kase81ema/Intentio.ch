...
const situations = [
  { text: "Feedback e delega non sono continui, il carico ricade su poche persone", accent: "bg-violet-600" },
  { text: "Obiettivi chiari, ma collaborazione e responsabilità restano confuse", accent: "bg-indigo-600" },
  { text: "Iniziative HR presenti, ma poca coerenza tra valori e pratiche quotidiane", accent: "bg-violet-600" },
  { text: "Conflitti latenti e riunioni che non portano decisioni", accent: "bg-indigo-600" },
  { text: "Serve una lettura oggettiva per scegliere priorità e interventi", accent: "bg-violet-600" },
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          >
            ...
            <div className="w-12 h-[3px] bg-gradient-to-r from-violet-600 to-indigo-600 mt-6 rounded-full" />
          </motion.div>
          ...
          <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-5">
            {situations.map((s, i) => (
              <motion.div
                ...
                className="flex items-start gap-4 bg-white p-6 border border-slate-200/60 hover:border-violet-300/60 hover:shadow-md transition-all duration-300 group"
